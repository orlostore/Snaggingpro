...
export const CRYSTAL_FOUR: BuildingDef = {
  ...
  levels: [
    {
      id: 'UG',
      label: 'Underground — −1.50',
      dwg: 'WS-01 · WS-08',
      planNote: 'No architectural plan exists for this level — see query Q2',
      areas: [
        { ref: 'UG-TANK', label: 'U/G water tank', kind: 'water_tank', group: 'plant', dwg: 'WS-01', note: '89 m³ · 47,800 imp gal — 10,300 domestic + 37,500 fire' },
        { ref: 'UG-PUMP', label: 'Transfer pump room', kind: 'pump_room', group: 'plant', dwg: 'WS-01', note: 'Duty + standby transfer pump set' },
        { ref: 'UG-SUMP', label: 'Sump pit', kind: 'pump_room', group: 'plant', dwg: 'Drainage', note: 'Sump + submersible pump' },
        { ref: 'UG-STR2', label: 'Stair-2 access', kind: 'stair', group: 'circulation', dwg: 'WS-01', note: 'The only access shown to this level' },
      ],
    },
    {
      id: 'G',
      ...
      areas: [
        ...
        { ref: 'STR2 G→1', label: 'Stair 2 — G to L1', kind: 'stair', group: 'circulation', dwg: 'A-102', note: 'Also continues down to the underground level' },
        ...
        { ref: 'G-PUMP', label: 'Pump room', kind: 'pump_room', group: 'plant', dwg: 'A-102', note: 'FFL −1.30 — relationship to the U/G tank room is Q2' },
    ...
    },
    {
      ...
      areas: [
        { ref: 'LIFT1-CAR', label: 'Lift 1 car', kind: 'lift_car', group: 'system' },
        { ref: 'LIFT1-SHAFT', label: 'Lift 1 shaft', kind: 'lift_shaft', group: 'system' },
        { ref: 'LIFT1-PIT', label: 'Lift 1 pit', kind: 'lift_pit', group: 'system', note: 'Below the ground slab — water ingress is the classic defect' },
        { ref: 'LIFT2-CAR', label: 'Lift 2 car', kind: 'lift_car', group: 'system' },
        { ref: 'LIFT2-SHAFT', label: 'Lift 2 shaft', kind: 'lift_shaft', group: 'system' },
        { ref: 'LIFT2-PIT', label: 'Lift 2 pit', kind: 'lift_pit', group: 'system' },
        ...
        { ref: 'BLD-FIRE', label: 'Fire systems', kind: 'fire_systems', group: 'system', note: 'Specialist FA/FF engineer — 1 week' },
