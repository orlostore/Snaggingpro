...
const C: Partial<Record<AreaKind, AreaChecklist>> = {
  ...
  stair: {
    ...
    items: {
      civil: [
        'Treads and risers — dimensional consistency',
        'Nosings — fitted, contrasting, secure',
        'Floor and wall finishes, landings',
        'Handrail height, continuity and fixings',
