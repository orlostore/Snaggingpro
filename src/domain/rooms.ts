...
export function buildRooms({ propType, bedrooms }: BuildRoomsInput): RoomTemplate[] {
  ...
  // Guest's Washroom — villas/townhouses and 2+ BR apartments
  if (villa || bedrooms >= 2) {
    rooms.push({
      id: 'guest_washroom',
      label: "Guest's Washroom",
      icon: '🚽',
      clKey: 'bathroom',
      discs: ['civil', 'electrical', 'hvac', 'plumbing'],
    });
  ...
  if (villa) {
    rooms.push({
      id: 'external_facade',
      label: 'External Facade',
      icon: '🏗',
      clKey: 'externalFacade',
      discs: ['civil'],
    });
    rooms.push({
      id: 'garage',
    ...
    rooms.push({
      id: 'booster_pump_room',
      label: 'Booster Pump Room',
      icon: '⚙️',
      clKey: 'boosterPumpRoom',
      discs: ['civil', 'mechanical', 'electrical'],
    });
    rooms.push({
      id: 'water_tank_ground',
      label: 'Water Tank (Ground/Underground)',
      icon: '💧',
      clKey: 'waterTankGround',
      discs: ['civil', 'mechanical', 'plumbing'],
    });
    rooms.push({
      id: 'water_tank_roof',
    ...
    rooms.push({
      ...
      icon: '☀️',
      clKey: 'solarWaterHeater',
      discs: ['civil', 'mechanical', 'electrical', 'plumbing'],
    });
  }
